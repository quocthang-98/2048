...
//
//    // Make a move
//    public static void makeMove(int[][] board, char move) {
//        if (move == 'w') {
//            // Move upwards
//            for (int j = 0; j < 4; j++) {
//                int[] column = new int[4];
...
//            for (int i = 0; i < 4; i++) {
//                int[] row = new int[4];
//                System.arraycopy(board[i], 0, row, 0, 4);
//                row = slideLine(row);
//                System.arraycopy(row, 0, board[i], 0, 4);
//            }
//        } else if (move == 's') {
//            // Move downwards
//            for (int j = 0; j < 4; j++) {
...
//    }
//
//    // Slide a line to the left
//    public static int[] slideLine(int[] oldLine) {
//        int[] newLine = new int[4];
//        int index = 0;
//
//        // Slide numbers on the line
//        for (int i = 0; i < 4; i++) {
//            if (oldLine[i] != 0) {
